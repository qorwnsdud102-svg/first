...
## 현재 inbox 내용 (2026-05-15 시점)

- 비어 있음.
- 이전 `iboss-근육돌이.bak/` (229 파일)는 2026-05-15 사장님 결정으로 `마케팅/raw/iboss-근육돌이/`로 활성화·이동 (dominant 도메인 schema 준수, `.bak` suffix 제거).
- 프로그램 측 ingest는 cross-domain reference로 진행 — `프로그램/wiki/sources/iboss-근육돌이/`에 메타 페이지를 두고 raw는 절대경로 `마케팅/raw/iboss-근육돌이/`로 참조.
