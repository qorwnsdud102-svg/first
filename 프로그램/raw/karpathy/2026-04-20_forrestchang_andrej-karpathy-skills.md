...
fetched: 2026-05-29
type: gist
authors: [forrestchang (multica-ai)]
intellectual_source: Andrej Karpathy (X post status/2015883857489522876)
license: MIT
content_date: 2026-04-20  # latest commit "Sync Chinese README with English version (add Cursor section) (#95)"
---

# multica-ai/andrej-karpathy-skills — 원본 번들 (편집 금지)

> 원본 GitHub 저장소 핵심 파일을 verbatim으로 묶음. README + CLAUDE.md + SKILL.md + EXAMPLES.md.
> CURSOR.md, README.zh.md는 제외 (운영 메타·중역어판이라 본 vault에서는 부수적).
